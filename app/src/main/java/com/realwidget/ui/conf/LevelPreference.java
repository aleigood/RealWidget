...
public class LevelPreference extends DialogPreference implements OnCheckedChangeListener {
    ...
    public void init(Context context) {
        ...
        lastLevel = getLevelRealList(config.getString(Constants.PREF_BRIGHT_LEVEL, Constants.DEFAULT_LEVEL));
    ...
    protected void onDialogClosed(boolean positiveResult) {
        if (positiveResult) {
            ...
            editor.putString(Constants.PREF_BRIGHT_LEVEL, getLevelRealStr());
            editor.commit();
        }
    }
    ...
    public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean) {
        ...
        if (txt.equals("0%")) {
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(0));
            }
        }
        if (txt.equals("10%")) {
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(10));
            }
            ...
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(20));
            }
            ...
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(30));
            }
            ...
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(40));
            }
            ...
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(50));
            }
            ...
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(60));
            }
            ...
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(70));
            }
            ...
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(80));
            }
            ...
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(90));
            }
            ...
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(100));
            }
            ...
            if (paramBoolean) {
                ...
                lastLevel.remove(Integer.valueOf(-1));
            }
        }
