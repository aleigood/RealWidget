...
import com.realwidget.ui.conf.LevelPreference;
...
public class BrightnessActivity extends Activity {
    ...
    public static final int BRIGHT_LEVEL_10 = 26;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        List<Integer> lastLevel = LevelPreference.getLevelRealList(config.getString(Constants.PREF_BRIGHT_LEVEL,
        ...
        // 通知widget按钮进行更新
        Utils.updateWidgets(BrightnessActivity.class.getName(), this);
    }
